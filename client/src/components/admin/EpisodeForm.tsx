...
const EpisodeForm = ({ episode, onUpdate, onDelete }: EpisodeFormProps) => {
  return (
    <Card className="bg-gradient-to-br from-black/90 via-dark-green/20 to-black/90 backdrop-blur-sm border border-border/50 relative overflow-visible">
      ...
      <CardContent className="space-y-3 relative overflow-visible">
