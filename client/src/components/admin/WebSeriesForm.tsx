  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 relative overflow-visible">
      ...
      <div className="space-y-4">
        ...
        {seasons.map((season) => (
          <Card key={season.id} className="bg-gradient-to-br from-black/90 via-dark-green/20 to-black/90 backdrop-blur-sm border border-border/50 relative overflow-visible">
            ...
            <CardContent className="space-y-4 relative overflow-visible">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) => {
                    ...
                    if (wordCount <= 1000 || e.target.value === '') {
                      updateSeason(season.id, { description: e.target.value });
                    }
                  }}
                  className="bg-background/50 border-border/50 focus:border-primary"
                  required
                ...
                <div className="text-sm text-muted-foreground">
                  Words: {season.description.trim().split(/\s+/).filter(word => word.length > 0).length}/1000
                </div>
              </div>
